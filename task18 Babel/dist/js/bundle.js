...
function form() {
  ...
  function sendAjaxData(formEvent) {
    ...
    formEvent.addEventListener('submit', function (event) {
      ...
      formEvent.appendChild(statusMessage); //sendAjaxData(formEvent);

      var formData = new FormData(formEvent);
...
function timer() {
  ...
  var deadLine = getTomorrow();

  function getTimeRemaining(endtime) {
    var t = Date.parse(deadLine) - Date.parse(new Date()),
        seconds = Math.floor(t / 1000 % 60),
        minutes = Math.floor(t / 1000 / 60 % 60),
        hours = Math.floor(t / 1000 / 60 / 60); //day     = Math.floor( (t/1000*60*60*24) );
...
function window() {
  var Options = /*#__PURE__*/function () {
    function Options(heigth, width, bg, fontSize, textAlign) {
    ...
    _createClass(Options, [{
      ...
      value: function createDiv() {
        ...
        div.style.cssText = "height:".concat(this.heigth, "px;width:").concat(this.width, "px;font-size:").concat(this.fontSize, "px;text-align:").concat(this.textAlign, ";background:").concat(this.bg);
